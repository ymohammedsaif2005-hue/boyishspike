...
export default function App() {
  return (
    <div className="min-h-screen bg-[#F5F5F0] text-[#121212] font-sans overflow-x-hidden selection:bg-[#C02626] selection:text-white">
      ...
      {/* Projects Section */}
      <section id="work" className="py-32 px-6 bg-[#F5F5F0]">
      ...
      {/* About Me Section */}
      <section id="about" className="py-32 px-6 bg-white border-b-2 border-[#121212]">
        <div className="max-w-7xl mx-auto">
      ...
      {/* Philosophy Section */}
      <section className="py-32 px-6 bg-white border-y-2 border-[#121212]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <div className="flex gap-12">
              ...
              <div>
                <p className="text-4xl font-black italic tracking-tighter">Responsive</p>
                <p className="text-xs font-bold uppercase tracking-widest opacity-60">Works on all screens</p>
              </div>
              <div>
                <p className="text-4xl font-black italic tracking-tighter">ROI-Focused</p>
      ...
      {/* Footer / Contact */}
      <footer id="contact" className="bg-[#121212] text-white py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-32">
            <h2 className="text-[8vw] font-black italic tracking-tighter uppercase leading-[0.8] mb-12">
              Ready to create an<br/><span className="text-[#C02626]">awesome website?</span>
            </h2>
            <div className="flex flex-col items-center gap-6">
              <a 
                href="mailto:boyishspike@gmail.com" 
                className="inline-flex items-center gap-4 text-3xl md:text-5xl font-black italic tracking-tighter uppercase hover:text-[#C02626] transition-colors group"
              >
              ...
              <a 
                ...
                className="text-2xl font-bold tracking-[0.2em] opacity-60 hover:opacity-100 transition-opacity"
              >
                +91 9500105451
              </a>
            </div>
